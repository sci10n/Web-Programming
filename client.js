...
showPanel = function(name){
	//content.homePanel.style.opacity = "0";
	//content.browsePanel.style.opacity = "0";
	//content.accountPanel.style.opacity = "0";
	...
	if(name === "home")
	{
		...
		//content.homePanel.style.opacity = "1";

	}
	else if(name === "browse")
	{
		browsePanel.style.display = "block";
		//content.browsePanel.style.opacity = "1";
	}
	else if(name === "account")
	{
		accountPanel.style.display = "block";
		//content.accountPanel.style.opacity = "1";
	}
